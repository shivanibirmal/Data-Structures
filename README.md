...
1. [Easy -  Build an Array With Stack Operations](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/ArrayWithStackOperations.py)
2. [Easy - Design a stack that supports push, pop, top, and retrieving the minimum element in constant time.](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/DesignStack.py)
3. [Medium - Find All Duplicates in an Array](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/FindDuplicatesInArray.py)
4. [Easy - Find All Numbers Disappeared in an Array](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/FindNumbersDisappearedInArray.py)
5. [Easy - Intersection of Two Arrays II](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/IntersectionOfTwoArrays_Complicated.py)
6. [Easy - Intersection of Two Arrays II](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/IntersectionOfTwoArrays_Easy.py)
7. [Medium - Kth Largest Element in an Array](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/KthLargestElementInArray.py)
8. [Easy - Maximum Subarray](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/MaximumSubarrayDivideAndConquer.py)
9. [Easy - Maximum Subarray](https://github.com/shivanibirmal/Data-Structures/blob/master/Arrays/MaximumSubarrayKadanesAgorithm.py)
